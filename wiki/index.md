...
| [Memoization in React](react/memoization.md) | useMemo, useCallback, React.memo -- when to use, pitfalls, children problem, and anti-patterns | 2026-04-13 |
...
| [React Context and Performance](react/react-context-performance.md) | Context for state distribution, re-render implications, splitting strategies, and higher-order component optimization | 2026-04-13 |
...
| [Data Fetching Patterns](react/data-fetching-patterns.md) | Client-side fetching, request waterfalls, race conditions, abort controllers, browser resource sharing | 2026-04-13 |
...
| [Bundle Size Optimization](react/bundle-size-optimization.md) | Code splitting, tree shaking, bundle analysis, vendor chunks, transitive dependencies, and compression | 2026-04-13 |
| [Lazy Loading and Suspense](react/lazy-loading-and-suspense.md) | React.lazy, Suspense boundaries, critical path extraction, preloading, and SSR interaction | 2026-04-13 |
...
| [Interaction Performance](react/interaction-performance.md) | INP measurement, SPA transitions, Long Tasks, yielding to main thread, React DevTools Profiler, and re-render-driven optimization | 2026-04-13 |
